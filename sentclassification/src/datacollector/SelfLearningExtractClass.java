...
public class SelfLearningExtractClass {
	...
	//Constructor 
	public SelfLearningExtractClass(String trainFileName, String testFileName) throws IOException{
	...
	public void classifyInstances() throws Exception{
		...
		BufferedWriter testWriter = new BufferedWriter(new FileWriter("C:/Users/Hospice/annotated_data/corpusout/IMradCorpusChi/MRCdataNormAll_2500CChiWithTenseExtract.arff")); //Newly labelled instances from the unlabelled file with large confidence will be appended to the labelled file.
	...
	public SelfLearningExtractClass(String trainFileName) throws IOException{
		this.trainFile = trainFileName;
		...
		BufferedWriter testWriter = new BufferedWriter(new FileWriter("C:/Users/Hospice/annotated_data/corpusout/IMradCorpusChi/MRCdataNormAll_2500CChiWithTenseExtract.arff")); //Newly labelled instances from the unlabelled file with large confidence will be appended to the labelled file.
		for (int i = this.train.numInstances() - 1; i >= 0; i--) {
			
			

					//trainWriter.append("\n" + labeled.instance(i).toString()); //add to the labelled file
					if (train.instance(i).toString().split(",")[2502].equals("background"))
						//testWriter.append("\n" + b+"\t"+ test.instance(i).toString().split(",")[2502]);
						//testWriter.append("\n" + b+"\t"+ test.instance(i).toString());

						testWriter.append("\n" + train.instance(i).toString());

					//System.out.println(train.instance(i).toString());
					//checking whether yes class or no class
					//if (clsLabel == 0.0){
					//	index[i] = 1; 
					//}
	...
	public static void main(String[] args) throws Exception{
		SelfLearningExtractClass SLEC = new SelfLearningExtractClass("C:/Users/Hospice/annotated_data/corpusout/IMradCorpusChi/annotated_words_tense_imrad.arff");
		//SLEC.classifyInstances();
	}
