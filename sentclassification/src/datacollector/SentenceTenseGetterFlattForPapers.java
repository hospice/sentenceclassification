...
public class SentenceTenseGetterFlattForPapers
  implements Serializable
{
  private LexicalizedParser lp;
  private static Map<String, Integer> verbMap;
  private static Set<String> sentVerbs ;
  public SentenceTenseGetterFlattForPapers(String grammerLocation)
  {
 ...
 /* public boolean[] parse(String sentence)
  ...
  public static void main(String[] args) throws IOException
  {
	...
	String [] dirList = rd.readDirectory("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiy");

	
	
	for (String file: dirList ){
		File class2verbs = new File ("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiywithtense/"+file.replace("txt","csv"));
    ...
    ArrayList<String> sList = loadCorpus("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiy/"+file);
    
    for (String sd : sList) {
    	SentenceTenseGetterFlattForPapers parser = new SentenceTenseGetterFlattForPapers("C:/Users/Hospice/backup/imrad_classifier/data/englishPCFG.ser.gz");
    ...
    String sent = n.normalize(sd.replaceAll(",",""));
   // System.out.println("///////////////////////////////////");
    if (sentVerbs.contains("VBZ")||sentVerbs.contains("VBP")){
    	sent = sent +","+true;   	
  ...
  public String sentenceWithTenseCSV(String sentence){
  ...
  //	sentVerbs = null;
  //	parser.hasVerb(sd.getNormalizedSentence());
  	getAllVerbs(parser.hasVerb(sentence));
    //  System.out.println(sentVerbs);
  	 Normalizer n = new Normalizer(true, true, false, false, false, true, true);
  String sent = n.normalize(sentence.replaceAll(",",""));
 // System.out.println("///////////////////////////////////");
  if (sentVerbs.contains("VBZ")||sentVerbs.contains("VBP")){
  	sent = sent +","+true;   	
