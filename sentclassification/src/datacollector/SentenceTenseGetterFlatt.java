...
public class SentenceTenseGetterFlatt
  implements Serializable
{
  private LexicalizedParser lp;
  private static Map<String, Integer> verbMap;
  private static Set<String> sentVerbs ;
  public SentenceTenseGetterFlatt(String grammerLocation)
  {
 ...
 /* public boolean[] parse(String sentence)
  ...
  {
	 String output = "";
	File class4verbs = new File ("C:/Users/Hospice/combinesentences/annotationSentencesPositive.csv");
    ...
    ArrayList<String> sList = loadCorpus("C:/Users/Hospice/combinesentences/annotationSentencesPositive.txt");
    
    for (String sd : sList) {
    	SentenceTenseGetterFlatt parser = new SentenceTenseGetterFlatt("C:/Users/Hospice/backup/imrad_classifier/data/englishPCFG.ser.gz");
