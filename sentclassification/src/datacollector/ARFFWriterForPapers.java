...
public class ARFFWriterForPapers
{
  ...
  public String  writeARFFSent(String file, SentenceData sd, String mutualInformationFile, int numFeaturesToUse, boolean useOriginalCategory, boolean useTenses, String categories)
  {
      String writeString = "";
    try
    {
...
public static void readSentDatatoArff(String sent ){
	
	SentenceData sd = SentenceDataReader.readSentenceData(sent);
    ARFFWriterForPapers writer = new ARFFWriterForPapers();
	    writer.writeARFFSent("", sd, "C:/Users/Hospice/annotated_data/corpusout/MRCdata/MRCSelf/Alldata98conf2500andtensetwoclassesbi_Chi.txt", 2500, false, true, "method,other");
  ...
  public static void main(String[] args) throws IOException {
	  Readdirectory rd = new Readdirectory();
		String [] dirList = rd.readDirectory("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiywithtense");
		for (String file: dirList ){
			//File class2verbs = new File ("C:/Users/Hospice/annotated_data/PaperOneSentencesWithTenseArff/"+file.replace("csv","arff"));
   ...
   // List<SentenceData> sdList = SentenceDataReader.readSentenceDate("C:/Users/Hospice/backup/USBFiles/annotated_data/400annotatedReduced.txt");
    List<SentenceData> sdList2 = SentenceDataReader.readSentenceDate("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiywithtense/"+file);
   ...
   // writer.writeARFF("C:/Users/Hospice/backup/USBFiles/annotated_data/ARFF/300annotatedReducedwithMRCMI_15000_withStop2Test.arff", sdList, "C:/Users/Hospice/backup/USBFiles/annotated_data/MIFeatures/annotate_MRCand400reduced_mi1_2_3grams.txt", 15000, false, false);
    writer.writeARFF("C:/Users/Hospice/resources/New_workspace/LDATests/linkagedata/filetoclassifiywithtenseArff/"+file.replace("csv","arff"), sdList2, "C:/Users/Hospice/annotated_data/corpusout/MRCdata/MRCSelf/Alldata98conf2500andtensetwoclassesbi_Chi.txt", 2500, false, true);
