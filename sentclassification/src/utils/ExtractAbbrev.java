...
public class ExtractAbbrev {
    ...
    ///Modified By Hospice 10/22/2014
    
    private void extractAbbrPairsFromFiles(String fileNmane){
    	File folder = new File(fileNmane);
    	File[] listOfFiles = folder.listFiles();
    	for(File file:listOfFiles){
    		String name = file.getAbsolutePath();
    		extractAbbrPairs(name);
    	}
	...
	extractAbbrev.extractAbbrPairsFromFiles(filename);
	if (extractAbbrev.testMode)
