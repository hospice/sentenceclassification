...
public class ImbalaceddataSplitandStratifiedCS {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		BufferedReader reader = new BufferedReader(new FileReader("C:/Users/Hospice/combinesentences/rteWithMultiTruth_out_Norm/all_0_12_3_45.arff"));
		
		//BufferedReader reader = new BufferedReader(new FileReader("C:/Users/Hospice/Downloads/edits-3.0.tar/edits/rte/annotatedCorpusAgain.arff"));
		...
		for (int seed = 1; seed <=10; seed++){
			...
			try {
				...
				evalAllStrat.evaluateModel(nbFCSF, holdoutTest);
