 ...
 */
public class NewPhraseChunker implements Chunker {
    ...
    public NewPhraseChunker(HmmDecoder posTagger,
    ...
    public static void main(String[] args) {
        ...
        NewPhraseChunker chunker = new NewPhraseChunker(posTagger,tokenizerFactory);
        ...
        for (int i = 2; i < args.length; ++i) {
          ...
          /*  String[] tokens 
            ...
            */
            ...
            Chunking chunking = chunker.chunk("This transition , located in exon 10 of the gene , produces an Arg-to-Gln substitution at amino acid 506 of the protein.");
